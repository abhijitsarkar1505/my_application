...
public class QuestionsActivity extends AppCompatActivity {
    ...
    String answers[] = {"B. Insects","B. Africa","B. Diphu, Assam","D. All of the above","B. Nazi Party","B. Film Finance Corporation","A. Dr. G. D. Bist","A. Horse racing","D. All of the above","D. Ultraviolet radiation"};
    String opt[] = {
